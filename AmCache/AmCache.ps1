...
$result =  ForEach ($item in $ipath){$i++
    ...
    if(($B.Hash).GetTypeCode() -eq "String"){$Hash = $B.Hash.substring(0,16)}else{$Hash = ($B.Hash.tostring()).substring(0,16)} #80b2426ebf16e24e
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCSoRJOk5HeQbeN
# CYH29tGp0Q3NzNtZZypK+bH7p6PSMaCCGf4wggQVMIIC/aADAgECAgsEAAAAAAEx
...
# 9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgrLzHfHh5IaNhE1ql
# zBaxaHkW6jOR9lAAd4rz4Y2Tj/YwDQYJKoZIhvcNAQEBBQAEggEAfovEPJpjQJfJ
# 9TkkR1VWoyM4d5miywJh2K6tvU325X866PqVtir061tUyg8S4gU6MBBFod2MZAT3
# 6tW8w9aypHlA+hN1aChAA/VcLdnO3IT9qV7N8+b+fjBV3oCAkUJJYEZrZnZqKxxH
# fVC/MBY+/9zojrqUymI/OKBypdOHeYMZhlSFrsafUfVXDp1HcVqxvPvzLgwK/mch
# 87oAVNaGz6qtVnjvXn9wkCuQeaoW/X1nWENu+g5EMpLHohQMSQXh8APXghZkvB/r
# 0EhFZ3jmf1FbSmyDE0tQHzyshHOcalxTh8XmxU5DDOGd33eJ96cU9qRT3LN5fA/w
# zfT8i4sl/qGCArkwggK1BgkqhkiG9w0BCQYxggKmMIICogIBATBrMFsxCzAJBgNV
...
# HAYJKoZIhvcNAQkFMQ8XDTIwMDMwMTEyMjg1M1owLwYJKoZIhvcNAQkEMSIEIPde
# Qg5EfuNGSbTlerWh4PS31h5hC2UiJSyLRjpm15qOMIGgBgsqhkiG9w0BCRACDDGB
...
# eDANBgkqhkiG9w0BAQEFAASCAQA3TXmlFLz1hNmB8PF2SA85p11OPG3j+L/7zoJJ
# 9dqBehUqp8gvZXYtGaKgjLWJZFi6LfsjRriElgUfvo6DfkABrFFflj6lWkGzwr7K
# 0JDfJnAvutS90WpBO1sKdYmEMKTHYSaKMzhqwB5Rq3f/l3jPLKnRzlSSK8l2uFR2
# m/4DlIej1rv280IYctV5jn0AuV6I9aXhQkZ7H/5LvBb8BC3dfLFZ7sngmGwvQOYT
# aBoYpx7dcy1Mv31rbeWl10xjt5N0W9lfwSUbC7lcBWfzc7Md1x6rgDI5YCewcsyf
# DutWxp60YkH04mn6XHW31wHFfPGcE2DXKglgjNLW9igjRGhZ
